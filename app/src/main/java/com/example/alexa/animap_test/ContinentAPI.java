...
public class ContinentAPI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_continent_api);  // This links our code to our layout which we defined earlier.
